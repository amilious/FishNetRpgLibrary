...
namespace Amilious.FunctionGraph.Nodes.Manipulators {
    ...
    /// <summary>
    /// This node is used to get the tangent for the given angle given in radians.
    /// </summary>
    [FunctionNode("This node is used to get the tangent for the given angle given in radians.")]
    public class Tangent : ManipulatorNodes {
        ...
        private float GetValue(CalculationId id) {
            ...
            return _lastValue = Mathf.Tan(value);
        }
