...
namespace Amilious.FunctionGraph.Nodes.Manipulators {
    ...
    /// <summary>
    /// This node is used to clamp the given input between 0 and 1 inclusively.
    /// </summary>
    [FunctionNode("This node is used to clamp the given input between 0 and 1 inclusively.")]
    public class Clamp01 : ManipulatorNodes {
        ...
        private float GetValue(CalculationId id) {
            ...
            return _lastValue = Mathf.Clamp01(value);
        }
