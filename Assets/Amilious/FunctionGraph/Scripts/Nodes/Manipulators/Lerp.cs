...
namespace Amilious.FunctionGraph.Nodes.Manipulators {
    ...
    /// <summary>
    /// This node is used to linearly interpolate between value 1 and value 2 by percent.
    /// </summary>
    [FunctionNode("This node is used to linearly interpolate between value 1 and value 2 by percent.")]
    public class Lerp : ManipulatorNodes {
        ...
        private float GetValue(CalculationId id) {
            ...
            return _lastValue = Mathf.Lerp(a,b,t);
        }
