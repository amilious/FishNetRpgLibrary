...
namespace Amilious.FunctionGraph.Nodes.Manipulators {
    ...
    /// <summary>
    /// This node is used to get the cosine for the given angle given in radians.
    /// </summary>
    [FunctionNode("This node is used to get the cosine for the given angle given in radians.")]
    public class Cosine : ManipulatorNodes {
        ...
        private float GetValue(CalculationId id) {
            ...
            return _lastValue = Mathf.Cos(value);
        }
