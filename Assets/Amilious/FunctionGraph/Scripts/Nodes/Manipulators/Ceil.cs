...
namespace Amilious.FunctionGraph.Nodes.Manipulators {
    ...
    /// <summary>
    /// This node is used to get the smallest integer greater than the given value.
    /// </summary>
    [FunctionNode("This node is used to get the smallest integer greater than the given value.")]
    public class Ceil : ManipulatorNodes {
        ...
        private float GetValue(CalculationId id) {
            ...
            return _lastValue = Mathf.Ceil(value);
        }
