...
namespace Amilious.FunctionGraph.Nodes.Manipulators {
    ...
    /// <summary>
    /// This node is used to get the sign of the given value.
    /// </summary>
    [FunctionNode("This node is used to get the sign of the given value.")]
    public class Sign : ManipulatorNodes {
        ...
        private float GetValue(CalculationId id) {
            ...
            return _lastValue = Mathf.Sign(value);
        }
