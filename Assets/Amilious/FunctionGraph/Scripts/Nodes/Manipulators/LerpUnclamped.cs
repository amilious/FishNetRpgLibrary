...
namespace Amilious.FunctionGraph.Nodes.Manipulators {
    ...
    /// <summary>
    /// This node is used to linearly interpolate between value 1 and value 2 by percent with no limit on the percent.
    /// </summary>
    [FunctionNode("This node is used to linearly interpolate between value 1 and value 2 by percent with no limit on the percent.")]
    public class LerpUnclamped : ManipulatorNodes {
        ...
        private float GetValue(CalculationId id) {
            ...
            return _lastValue = Mathf.LerpUnclamped(a,b,t);
        }
