...
namespace Amilious.FunctionGraph.Nodes.LogicNodes {
    ...
    /// <summary>
    /// This node is used to check if the value is less than or equal to the test.
    /// </summary>
    [FunctionNode("This node is used to check if the value is less than or equal to the test.")]
    public class LessThanOrEqual : LogicNodes {
