...
namespace Amilious.FunctionGraph.Nodes.LogicNodes {
    ...
    /// <summary>
    /// This node is used to check if the value is greater than the test.
    /// </summary>
    [FunctionNode("This node is used to check if the value is greater than the test.")]
    public class GreaterThan : LogicNodes {
