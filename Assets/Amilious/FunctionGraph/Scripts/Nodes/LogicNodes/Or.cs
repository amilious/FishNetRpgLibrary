...
namespace Amilious.FunctionGraph.Nodes.LogicNodes {
    ...
    /// <summary>
    /// This node is used to check if any values are true.
    /// </summary>
    [FunctionNode("This node is used to check if any values are true.")]
    public class Or : LogicNodes {
        ...
        private bool GetResult(CalculationId id) {
            ...
            return _lastValue = values.Any(x=>x);
        }
