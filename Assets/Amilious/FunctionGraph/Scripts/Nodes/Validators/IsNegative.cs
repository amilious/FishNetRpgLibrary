...
namespace Amilious.FunctionGraph.Nodes.Validators {
    ...
    /// <summary>
    /// This node is used to check if a value is negative.
    /// </summary>
    [FunctionNode("This node is used to check if a value is negative.")]
    public class IsNegative : ValidatorNodes {
